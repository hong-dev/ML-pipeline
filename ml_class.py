...
class TestSplit:
    ...
    def split_test(self, dataset, target):
        ...
        X_train, X_validation, y_train, y_validation = train_test_split(self.features_without_target, self.target_feature)
...
class Preprocessor(TransformerMixin):
    ...
    def transform_columns(self):
        return ColumnTransformer(transformers = [
            ('numeric', self.transform_numeric_features(), self.numeric_features),
            ('categorical', self.transform_categorical_features(), self.categorical_features)
            ])
    ...
    def get_column_names(self):
        cats_names = self.column_transformer.named_transformers_['categorical']['onehot'].get_feature_names(self.categorical_features)
